...
<head>
    ...
    <style>
        ...
        .navbar {
            background: linear-gradient(90deg, #ee9bb7, #d8b9ff);
        ...
        @media (max-width: 991px) {
            .navbar-nav {
                background: linear-gradient(90deg, #f09eba, #d8b9ff);
                border-radius: 10px;
                padding: 1rem;
                margin-top: 0.5rem;
            }
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navmenu">
                <ul class="navbar-nav ms-auto">
                    <?php if ($this->session->userdata('logged_in')): ?>
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('dashboard'); ?>">Dashboard</a>
                        </li>
                        <li class="nav-item"><a class="nav-link"
                                href="<?php echo base_url('transactions'); ?>">Transactions</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('categories'); ?>">Categories</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('profile'); ?>">Profile</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url('auth/logout'); ?>">Logout</a>
                        </li>
                    <?php else: ?>
    ...
    <!-- Bootstrap 5 JS (includes Popper.js, no jQuery) -->
